...
In this course, we'll primarily be interested in /dynamic semantics/ proper, rather than discourse representation theories [cite:@Kamp1981], which are often grouped under the same umbrella.
...
- *Obligatory reading:* Groenendijk and Stokhof's classic paper /dynamic predicate logic/ [cite:@GroenendijkStokhof1991].
- *Optional reading:* Thony Gillies' /re-reading dynamic predicate logic/ [cite:@Gillies2019].
...
Other examples making a similar point:
